...
/**
 * Component for "TestimonialsQuoteSlideshow" Slices.
 */
const TestimonialsQuoteSlideshow = ({ testimonials }: TestimonialsQuoteSlideshowProps): JSX.Element => {
                                    ...
                                    <div className="flex flex-col lg:flex-row lg:items-start">
                                        ...
                                        <div className="flex items-center mt-auto lg:block lg:mt-0 lg:ml-20">
                                            ...
                                            <div>
                                                ...
                                                <div className="caption text-n-1/25">{data.job_title}</div>
                                            </div>
                                        </div>
                                    </div>
                                </SplideSlide>
...
export default TestimonialsQuoteSlideshow;
